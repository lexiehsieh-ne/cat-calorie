...
const FEATURES = [
  ...
  },
  {
    ...
    emoji: "💬",
    title: "多輪追問，收集關鍵資訊",
    description: "AI 會視需要詢問體重、絕育狀態、活動量等資訊，問題數不設限。",
  },
  {
    number: "03",
    emoji: "📚",
...
const STEPS = [
  ...
  },
  {
    emoji: "🗨️",
    title: "回答 AI 的追問",
    description: "AI 會依需要詢問體重、絕育狀態、活動量等問題，逐步完善資料。",
  },
  {
    emoji: "🍽️",
    title: "取得熱量與飲食建議",
...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      "準確估算熱量需要體重、絕育狀態、活動量、體態等資訊，AI 會依你提供的資料動態決定還需要問哪些問題，並非固定題數。",
  },
  {
  ...
  return (
    <>
      ...
      <div className="flex flex-1 flex-col bg-background">
        ...
        <section className="mx-auto grid w-full max-w-5xl gap-16 px-6 pb-20 pt-16 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-6 max-w-md leading-7 text-foreground/70">
              PawCal 依據 AAFCO 與 NRC 標準，透過幾個問題了解你的貓咪，計算每日所需熱量並提供飲食建議。
            </p>
        ...
        {/* Features */}
        <section id="features" className="border-y border-line bg-card/60">
        ...
        {/* FAQ */}
        <section id="faq" className="border-y border-line bg-card/60">
